...
format, 
parseMention, 
getRandom } = require('./folderfungsi_/fungsiperintah')
...
const kalimage = fs.readFileSync ('./media_/poto/haikal.jpg')
// Public & Self
if (!ikall.public) {
...
case 'menu': {
let buttons = [
{buttonId: `home`, buttonText: {displayText: 'Dashboard 🏠'}, type: 1}
]
let buttonMessage = {
image: kalimage,
caption: `MENU LIST`,
...
ikall.sendMessage(m.chat, buttonMessage, { quoted: m })
}
break
...
[
  ...
  {
   "buttonId": `${prefix}mulai ${pushname}`,
    "buttonText": 
